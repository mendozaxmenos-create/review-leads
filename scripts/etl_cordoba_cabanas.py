"""ETL / auditoría de la base Córdoba · cabañas ready.
...
# Sin blocklists de Mendoza (Villa Oliva / Las Leñas).
BLOCKED_PLACE_NAMES: tuple[str, ...] = ()
...
def main() -> int:
    ...
    parser.add_argument(
        "--csv",
        default=str(EXPORT / "cordoba-cabanas-ready.csv"),
    ...
    clean_path = EXPORT / "cordoba-cabanas-etl-clean.csv"
    clean_stamped = EXPORT / f"cordoba-cabanas-etl-clean-{stamp}.csv"
    quar_path = EXPORT / "cordoba-cabanas-etl-quarantine.csv"
    report_path = EXPORT / "cordoba-cabanas-etl-report.json"
    ...
    # Alias para upload/dashboard multi-base (no pisa Mendoza)
